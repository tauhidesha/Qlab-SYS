...
const mockServicesProducts: ServiceProduct[] = [
  { id: 'S001', name: 'Cuci Motor Premium', type: 'Layanan', category: 'Pencucian', price: 75000, description: 'Cuci lengkap termasuk bodi, mesin, dan roda.' },
  { id: 'S002', name: 'Paket Detailing Lengkap', type: 'Layanan', category: 'Detailing', price: 350000, description: 'Termasuk cuci, poles, wax, dan pembersihan interior.' },
  { id: 'P001', name: 'Pelumas Rantai (Merek X)', type: 'Produk', category: 'Pelumas', price: 60000, description: 'Pelumas rantai performa tinggi, 250ml.' },
  { id: 'P002', name: 'Set Handuk Mikrofiber', type: 'Produk', category: 'Aksesoris', price: 50000, description: 'Set isi 3 handuk mikrofiber premium.' },
  { id: 'S003', name: 'Sanitasi Helm', type: 'Layanan', category: 'Kebersihan', price: 20000, description: 'Membunuh kuman dan menyegarkan interior helm.' },
];
