...
"[project]/src/services/whatsappService.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function sendWhatsAppMessage(number, message) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            return {
                success: false,
                error: `Server WhatsApp error: ${response.status} - ${errorData.error || errorData.details || response.statusText}`
            };
        }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$whatsappService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/whatsappService.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/date-fns/format.mjs [app-rsc] (ecmascript) <locals>");
...
async function generateWhatsAppReply({ customerMessage, senderNumber, chatHistory }) {
    ...
    try {
        ...
        if (docSnap.exists()) {
            ...
            const parsedSettings = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$aiSettings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AiSettingsFormSchema"].safeParse(rawSettingsData);
...
Mohon segera tindak lanjuti.`;
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$whatsappService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sendWhatsAppMessage"])(agentSettings.humanAgentWhatsAppNumber, handoffNotificationMessage);
...
2.  **Info Umum/Kebijakan/Pemetaan Ukuran:** Jika pertanyaan umum (jam buka, alamat, kebijakan garansi, ATAU jika perlu mengetahui pemetaan ukuran motor seperti apakah XMAX itu XL), gunakan \`getKnowledgeBaseInfoTool\`. JANGAN menebak informasi yang tidak ada di output tool. Jika tool sedang digunakan, JANGAN mengatakan "sedang loading" atau semacamnya, tunggu hasilnya lalu gunakan untuk menjawab.
3.  **Detail Produk/Layanan (Harga/Durasi):**
    *   Jika pertanyaan terkait harga/durasi layanan yang memiliki **VARIAN BERDASARKAN UKURAN MOTOR** (misalnya Paket Detailing S, M, L, XL):
        1.  Pertama, jika nama motor disebutkan (mis. XMAX, Vario) tapi ukurannya tidak jelas, **WAJIB LANGKAH 1**: Panggil \`getKnowledgeBaseInfoTool\` untuk mencari informasi tentang kategori ukuran motor tersebut (mis. query: "Ukuran motor XMAX" atau "XMAX masuk kategori ukuran apa?").
        2.  **WAJIB LANGKAH 2 (setelah Langkah 1)**:
    ...
    *   Untuk layanan lain yang harganya spesifik atau tidak memiliki varian ukuran motor, langsung gunakan \`getProductServiceDetailsByNameTool\` dengan nama layanan sejelas mungkin. Tanyakan jenis motor/cat jika diperlukan oleh layanan tersebut SEBELUM memanggil tool ini.
...
*   **Hindari Narasi Proses Internal**: JANGAN PERNAH menyertakan frasa seperti "*loading knowledge base...*", "*mencari data...*", "*sedang mengecek...*", atau teks placeholder semacam itu dalam balasan Anda. Jika Anda perlu menggunakan tool, gunakan hasilnya untuk menjawab, atau jika tool tidak menemukan info, sampaikan itu dengan jelas dan sopan. Jangan mengatakan "tunggu sebentar" lalu tidak memberikan jawaban yang relevan dari tool di giliran balasan yang sama.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2ab68832._.js.map