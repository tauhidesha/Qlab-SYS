...
async function findMotorSize(input) {
    ...
    try {
        ...
        if (!querySnapshot.empty) {
            ...
            querySnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDocs"])(aliasQuery);
            if (!querySnapshot.empty) {
                foundVehicleData = querySnapshot.docs[0].data();
        ...
        if (!foundVehicleData) {
            ...
            const allVehiclesSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDocs"])(vehicleTypesRef); // Pertimbangkan untuk membatasi ini jika koleksi sangat besar
